...
const Restaurant = () => {
  ...
  return (
    ...
    <div className='w-screen md:w-1/2  rounded-2xl shadow-md'>
          ...
          {resMenu.map((item)=>{
            return <div className='mx-4 flex my-10 pb-2 border-b-2 '>
              <div className='w-3/4'>
                    <h3>🍽</h3>
              ...
              <button onClick={()=>{
                handleButton(item)
                alert("Added to cart")}
              } className='absolute border border-black mx-4 mb-4 px-8 py-1 rounded-xl text-green-600 font-bold'>ADD</button>
              </div>
            </div>
